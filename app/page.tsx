    ...
    <>
      <section className="relative -mt-20 flex h-[calc(100svh/var(--dz,1))] min-h-[560px] items-center justify-center overflow-hidden bg-aio-black text-white lg:-mt-24">
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-[1280px] flex-col items-center px-6 pt-20 text-center lg:pt-24">
          ...
          <p className="hero-item mx-auto mt-6 max-w-[34ch] text-center text-base font-semibold leading-7 text-white text-balance sm:max-w-[680px] sm:text-lg md:leading-8" style={{ animationDelay: "560ms" }}>
